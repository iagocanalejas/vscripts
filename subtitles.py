...
def _match_subs(root: str, file_path: str) -> Optional[str]:
    ...
    for i in os.listdir(root):
        ...
        if os.path.isfile(maybe_match) and extension in [".ass", ".srt", ".ssa"] and file_name in i:
            return maybe_match
    ...
    for i in os.listdir(subs_folder):
        ...
        if os.path.isfile(maybe_match) and file_name in i:
            return maybe_match
...
if __name__ == "__main__":
    ...
    for i in os.listdir(args.path):
        ...
        if os.path.isfile(maybe_file) and extension in [".mkv", ".mp4"]:
